 ...
 *
 * PROBLEMA:
 *   In nuxt.config.ts, sanctum.baseUrl è impostato a "http://127.0.0.1:8787"
 *   per il funzionamento locale. Ma quando il sito è condiviso tramite tunnel
 *   Cloudflare (es. https://abc123.trycloudflare.com), le chiamate API del browser
 *   andrebbero a http://127.0.0.1:8787 che è:
 ...
 *   2. Irraggiungibile da browser remoti (127.0.0.1 è il LORO localhost, non il server)
 *
 * SOLUZIONE:
