		...
		<div class="space-y-[12px]">
			...
			<div class="sf-admin-hero-preview__frame p-[8px]">
				...
				<div
					...
					class="relative overflow-hidden rounded-[16px] border border-[#D3DEE6] aspect-[1440/700] bg-[#EEF3F7]">
					<iframe
			...
			<div class="sf-admin-hero-preview__frame p-[8px] w-full max-w-[980px]">
				...
				<div
					...
					class="relative overflow-hidden rounded-[16px] border border-[#D3DEE6] aspect-[390/220] bg-[#EEF3F7]">
					<iframe
