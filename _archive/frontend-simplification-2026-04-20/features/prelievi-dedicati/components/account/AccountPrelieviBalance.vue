...
<template>
	<div class="mb-[20px] grid gap-[14px] desktop:grid-cols-[minmax(0,1.12fr)_minmax(300px,0.88fr)] desktop:items-stretch">
		<!-- Saldo -->
			...
			<div class="flex flex-col gap-[16px] desktop:flex-row desktop:items-center desktop:justify-between">
				<div>
					<div class="flex items-center gap-[8px] mb-[10px]">
						...
						<p class="text-[0.75rem] uppercase tracking-[1.2px] font-medium text-[var(--color-brand-primary)]">Saldo prelevabile</p>
					</div>
					...
					<p class="text-[0.75rem] text-[var(--color-brand-text-secondary)] mt-[6px]">Commissioni confermate e pronte per richiesta</p>
				</div>
				<div class="flex flex-col items-start desktop:items-end gap-[8px]">
					<button
						...
						class="btn-primary btn-compact w-full desktop:w-auto inline-flex items-center justify-center gap-[8px]">
		...
		<!-- Come funziona -->
		<div class="rounded-[16px] bg-white p-[16px] desktop:p-[20px]" style="box-shadow: 0 2px 8px rgba(9,88,102,0.06), 0 0 0 1px rgba(9,88,102,0.04);">
			<h3 class="font-montserrat text-[0.875rem] font-[800] text-[var(--color-brand-text)] mb-[14px] flex items-center gap-[8px]">
				<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-primary)" stroke-width="2">
					<circle cx="12" cy="12" r="10" />
			...
			<div class="space-y-[12px]">
				<div v-for="(step, idx) in steps" :key="idx" class="flex items-start gap-[10px]">
					<div
