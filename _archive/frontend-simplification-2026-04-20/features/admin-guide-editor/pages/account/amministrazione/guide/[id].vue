...
useSeoMeta({
	title: 'Admin - Modifica Guida | SpediamoFacile',
	...
	<section class="sf-account-shell min-h-[600px] py-[24px] tablet:py-[28px] desktop:py-[28px]">
		<div class="my-container">
			<AccountPageHeader
				...
				description="Aggiorna contenuto, immagine e stato di pubblicazione."
				:crumbs="[
			...
			<template v-else>
				<div class="space-y-[16px]">
					...
					<div class="sf-surface-card rounded-[16px] p-[18px] desktop:p-[20px]">
						...
						<div class="max-w-[700px]">
							<div v-if="form.image_url" class="mb-[14px]">
								<!-- width/height intrinseche per prevenire CLS (preview guida). -->
								<img :src="form.image_url" alt="Immagine guida" loading="lazy" decoding="async" width="320" height="180" class="max-w-full max-h-[180px] rounded-[12px] object-cover" />
							</div>
					...
					<div class="flex justify-end">
						<button @click="saveGuide" :disabled="saving" type="button" class="btn-cta btn-compact inline-flex items-center gap-[6px] disabled:opacity-50">
