...
/** @typedef {import('~/types').EuropePricing} EuropePricing */
/** @typedef {import('~/types').PricingRule} PricingRule */
/** @typedef {import('~/types').PricingRuleGroup} PricingRuleGroup */
...
/** @returns {object} */
export const buildPricingRulesPayload = (group = {}) =>
