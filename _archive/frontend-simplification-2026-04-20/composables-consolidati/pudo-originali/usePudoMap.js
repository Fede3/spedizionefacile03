 ...
 * usePudoMap.js
 *
 * Helper per la mappa PUDO: selezione, dettagli on-demand, orari di oggi,
 * stato aperto/chiuso, formattazione distanza. Condiviso tra selector funnel
 * e pagina pubblica /pudo.
 *
 * @typedef {{ label: string, className: string }} PudoStatus
 */
import { ref } from 'vue'

/** Composable helper mappa PUDO: espone selezione, dettagli e info (orari/distanza/stato). */
