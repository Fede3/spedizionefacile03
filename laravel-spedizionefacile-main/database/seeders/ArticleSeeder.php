    ...
    private function getGuides(): array
    {
        return [
            ...
            [
                ...
                'sections' => [
                    ['heading' => 'Il codice di tracciamento', 'text' => 'Dopo aver confermato la spedizione, ricevi un codice di tracciamento (tracking number) univoco che identifica il tuo pacco all\'interno della rete del corriere. Questo codice ti viene inviato via email e lo trovi anche nella tua area personale su SpedizioneFacile. Conservalo fino alla conferma di avvenuta consegna: è lo strumento principale per monitorare lo stato della spedizione e per qualsiasi comunicazione con il servizio assistenza.'],
                    ['heading' => 'Dove inserire il codice tracking', 'text' => 'Puoi tracciare la tua spedizione direttamente dalla tua area personale su SpedizioneFacile, dove trovi lo stato aggiornato di tutti i tuoi ordini in un unico pannello. In alternativa, puoi usare il codice tracking sul sito web del corriere che gestisce la consegna. SpedizioneFacile ti indica sempre quale corriere è stato assegnato alla tua spedizione, così sai esattamente dove cercare informazioni più dettagliate se necessario.'],
            ...
            [
                ...
                'meta_description' => 'Come funziona il contrassegno: pagamento alla consegna con i corrieri, limiti, costi e procedura su SpedizioneFacile.',
                ...
                'sections' => [
                    ...
                    ['heading' => 'Come attivarlo su SpedizioneFacile', 'text' => 'Durante la creazione della spedizione su SpedizioneFacile, trovi l\'opzione "Pagamento alla consegna" tra i servizi aggiuntivi. Attivandola, ti viene chiesto di indicare l\'importo da incassare e la modalità di riversamento preferita (accredito su conto corrente o portafoglio SpedizioneFacile). L\'importo del contrassegno viene stampato sull\'etichetta e comunicato al corriere. Il sovrapprezzo per il servizio viene mostrato prima della conferma dell\'ordine.'],
            ...
            [
                ...
                'sections' => [
                    ...
                    ['heading' => 'Copertura territoriale', 'text' => 'Non tutti i corrieri coprono allo stesso modo l\'intero territorio. Alcuni sono particolarmente forti sulle tratte nord-sud, altri hanno una rete capillare nelle zone rurali, altri ancora eccellono nelle consegne urbane. Per le isole e le zone disagiate, verifica che il corriere offra un servizio regolare e a costi ragionevoli. SpedizioneFacile ti mostra solo i corrieri che effettivamente servono la tratta che ti interessa, evitando sorprese.'],
            ...
            [
                ...
                'sections' => [
                    ['heading' => 'Spedizioni nazionali', 'text' => 'Per le spedizioni all\'interno dell\'Italia, la documentazione richiesta è minima: serve l\'etichetta di spedizione con i dati completi del mittente e del destinatario (nome, indirizzo completo con CAP, numero di telefono). L\'etichetta viene generata automaticamente da SpedizioneFacile dopo la conferma dell\'ordine e può essere stampata o, dove il corriere lo consente, gestita in formato digitale. Per vendite commerciali, è buona pratica allegare il documento di trasporto (DDT) con la descrizione del contenuto.'],
                    ['heading' => 'Spedizioni nell\'Unione Europea', 'text' => 'All\'interno dell\'UE, le merci circolano liberamente senza formalità doganali per i beni commercializzati legalmente. Tuttavia, per spedizioni commerciali è necessaria la fattura o il documento di trasporto che attesti la natura della merce e il suo valore. Per alcune categorie merceologiche (alimentari, farmaci, prodotti fitosanitari) possono essere richiesti certificati specifici anche all\'interno dell\'UE. SpedizioneFacile ti guida nella preparazione della documentazione corretta.'],
            ...
            [
                ...
                'sections' => [
                    ...
                    ['heading' => 'Come verificare se puoi spedire un oggetto', 'text' => 'In caso di dubbio, consulta le condizioni generali del corriere scelto o contatta il servizio assistenza di SpedizioneFacile prima di preparare la spedizione. Durante la creazione dell\'ordine, ti chiediamo una descrizione del contenuto: se rileveremo possibili incompatibilità, ti avviseremo prima della conferma. Meglio investire qualche minuto in una verifica preventiva che rischiare il sequestro della merce, sanzioni o la perdita della copertura assicurativa per dichiarazione non conforme.'],
                ],
                'faqs' => null,
            ],
            [
            ...
            [
                ...
                'sections' => [
                    ...
                    ['heading' => 'Quanto costa', 'text' => 'Il costo dell\'assicurazione è proporzionale al valore dichiarato della merce, tipicamente tra l\'1% e il 3% del valore. Per un pacco del valore di 200 euro, l\'assicurazione costa indicativamente 2-6 euro. Su SpedizioneFacile, il costo esatto viene calcolato e mostrato durante la creazione dell\'ordine, prima della conferma del pagamento. Rispetto al valore della merce, si tratta di un investimento minimo che offre una protezione significativa.'],
                    ...
                    ['heading' => 'Come richiedere il rimborso', 'text' => 'In caso di danno o smarrimento, apri un reclamo dalla tua area personale SpedizioneFacile entro i tempi previsti (generalmente 5-7 giorni dalla consegna per danni visibili). Dovrai fornire: foto del pacco e del contenuto danneggiato, prova del valore della merce (fattura, ricevuta, listino), descrizione dettagliata del danno. Il nostro team gestisce la pratica con il corriere e la compagnia assicurativa, tenendoti aggiornato sullo stato del rimborso.'],
                ],
                'faqs' => null,
            ],
            [
    ...
    private function getServices(): array
    {
        return [
            [
                ...
                'meta_description' => 'Spedisci con pagamento alla consegna: il corriere incassa per tuo conto al momento della consegna. Scopri come funziona il contrassegno con SpedizioneFacile.',
                ...
                'sections' => [
                    ...
                    ['heading' => 'Come funziona con SpedizioneFacile', 'text' => 'Nel modulo di spedizione attivi "Pagamento alla consegna" e inserisci: importo da incassare, descrizione breve per ricevuta del destinatario, modalità di riversamento preferita (accredito su conto, rimessa su portafoglio interno, altra opzione disponibile). Il sistema stampa l\'indicazione del contrassegno sull\'etichetta e nei documenti che accompagnano il collo.'],
            ...
            [
                ...
                'meta_description' => 'Spedisci senza stampare l\'etichetta: il corriere la gestisce per te. Scopri come funziona il servizio senza etichetta di SpedizioneFacile.',
                ...
                'faqs' => [
                    ...
                    ['title' => 'Tutti i corrieri supportano questa opzione?', 'text' => 'No, il servizio è disponibile con i corrieri che offrono la gestione digitale dell\'etichetta. SpedizioneFacile ti mostra le opzioni disponibili durante la creazione dell\'ordine.'],
                ],
            ],
            [
                'slug' => 'ritiro-a-domicilio',
                'title' => 'Ritiro a domicilio',
                'meta_description' => 'Il corriere viene a casa tua a ritirare il pacco. Scopri come funziona il ritiro a domicilio con SpedizioneFacile.',
            ...
            [
                ...
                'meta_description' => 'Proteggi i tuoi pacchi con l\'assicurazione SpedizioneFacile: copertura per danni, smarrimento e furto durante il trasporto.',
            ...
            [
                ...
                'meta_description' => 'Servizio di consegna e ritiro con sponda idraulica per colli pesanti e voluminosi. Scopri come funziona con SpedizioneFacile.',
                ...
                'sections' => [
                    ...
                    ['heading' => 'Come richiederlo', 'text' => 'Durante la creazione della spedizione su SpedizioneFacile, seleziona "Sponda idraulica" tra i servizi aggiuntivi. Il sistema mostra automaticamente questa opzione quando il peso o le dimensioni del pacco la rendono consigliabile. Il servizio è disponibile sia per il ritiro che per la consegna, e puoi richiederlo per una o entrambe le operazioni in base alle esigenze.'],
            ...
            [
                ...
                'meta_description' => 'Programma le tue spedizioni in anticipo con SpedizioneFacile: scegli data e orario di ritiro e consegna.',
            ...
            [
                ...
                'meta_description' => 'Il corriere chiama prima di consegnare: scopri il servizio di chiamata pre-consegna di SpedizioneFacile.',
                ...
                'sections' => [
                    ...
                    ['heading' => 'Costi e disponibilità', 'text' => 'Il servizio di chiamata pre-consegna è disponibile come servizio accessorio con un piccolo sovrapprezzo. Non tutti i corrieri lo offrono su tutte le tratte. La disponibilità viene mostrata durante la creazione della spedizione su SpedizioneFacile. È fondamentale che il numero di telefono del destinatario sia corretto e raggiungibile durante l\'orario di consegna.'],
                ],
                'faqs' => [
            ...
            [
                ...
                'meta_description' => 'Assistenza dedicata e tempi di risposta rapidi per le tue spedizioni. Scopri il servizio di assistenza rapida SpedizioneFacile.',
                ...
                'sections' => [
                    ...
                    ['heading' => 'Come attivarlo', 'text' => 'L\'assistenza rapida può essere attivata come servizio aggiuntivo su singole spedizioni o come abbonamento per tutte le tue spedizioni. Dalla tua area personale su SpedizioneFacile, vai nella sezione Assistenza e scegli la modalità che preferisci. Per le aziende con volumi elevati, il servizio può essere incluso nelle condizioni personalizzate.'],
                ],
                'faqs' => [
            ...
            [
                ...
                'meta_description' => 'Accumula punti con ogni spedizione e ottieni sconti e vantaggi esclusivi con il programma fedeltà SpedizioneFacile.',
                'intro' => 'Con il programma punti fedeltà di SpedizioneFacile, ogni spedizione ti fa guadagnare punti che puoi convertire in sconti sulle spedizioni successive. Più spedisci, più risparmi.',
