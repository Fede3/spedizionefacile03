 ...
 *
 * Handles order and shipment administration: listing orders, updating
 * statuses, managing PUDO points, listing BRT shipments, and regenerating labels.
 */
