	...
	<div class="rounded-[14px] border border-[#E9EBEC] bg-[#F8FBFD] p-[12px] desktop:p-[14px]">
		...
		<div class="space-y-[12px]">
			...
			<div class="rounded-[12px] border border-[#DCE5EC] bg-white p-[8px]">
				...
				<div ref="localDesktopViewport" class="relative overflow-hidden rounded-[12px] border border-[#D3DEE6] aspect-[1440/700] bg-[#EEF3F7]">
			...
			<div class="rounded-[12px] border border-[#DCE5EC] bg-white p-[8px] w-full max-w-[980px]">
				...
				<div ref="localMobileViewport" class="relative overflow-hidden rounded-[12px] border border-[#D3DEE6] aspect-[390/220] bg-[#EEF3F7]">
