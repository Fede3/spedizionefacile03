	...
	<div class="bg-white rounded-[12px] p-[16px] tablet:p-[20px] desktop:p-[28px] shadow-sm border border-[#E9EBEC] overflow-hidden">
		...
		<div v-else class="space-y-[20px]">
			...
			<div class="flex justify-end">
				<button type="button" @click="savePromo" :disabled="promoSaving" class="inline-flex items-center gap-[8px] px-[24px] py-[12px] bg-[#E44203] hover:bg-[#c93800] text-white rounded-[50px] text-[0.875rem] font-medium transition-colors cursor-pointer disabled:opacity-50">
