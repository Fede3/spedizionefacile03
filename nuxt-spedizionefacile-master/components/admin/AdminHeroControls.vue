...
<template>
	<div class="sf-admin-hero-panel">
		...
		<div
			v-if="selectedFile"
			class="mt-[10px] rounded-[14px] border border-[#dce5ec] bg-white px-[12px] py-[10px] text-[0.75rem] text-[var(--color-brand-text)] flex items-center justify-between gap-[10px]">
		...
		<div class="mt-[14px]">
			...
			<div class="grid grid-cols-2 gap-[8px]">
				<button
					...
					class="h-[34px] rounded-[14px] text-[0.8125rem] font-semibold border"
		...
		<div class="mt-[14px]">
			...
			<div class="grid grid-cols-3 gap-[8px]">
				<button
					...
					class="h-[34px] rounded-[14px] text-[0.8125rem] font-semibold border capitalize"
		...
		<div class="mt-[14px] grid grid-cols-2 gap-[8px]">
			<button
				...
				class="h-[36px] rounded-[14px] border border-[#B9D4DC] bg-white text-[var(--color-brand-primary)] font-semibold text-[0.8125rem] hover:bg-[#F1F8FA]">
				Reset viewport
			</button>
			<button
				type="button"
