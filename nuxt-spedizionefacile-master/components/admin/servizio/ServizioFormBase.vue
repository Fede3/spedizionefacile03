	...
	<section class="sf-account-panel service-editor-panel service-editor-panel--teal rounded-[16px] p-[20px]">
		...
		<div class="service-editor-field-grid">
			...
			<div class="service-editor-field service-editor-field--half">
				...
				<input :value="slug" @input="emit('update:slug', ($event.target as HTMLInputElement).value)" type="text" class="service-editor-input service-editor-input--mono" placeholder="titolo-del-servizio" />
			...
			<div class="service-editor-field">
				...
				<textarea :value="metaDescription" @input="emit('update:metaDescription', ($event.target as HTMLTextAreaElement).value)" rows="2" class="service-editor-textarea" placeholder="Descrizione per i motori di ricerca"></textarea>
			</div>
			<div class="service-editor-field">
				<label class="service-editor-label">Introduzione</label>
				<textarea :value="intro" @input="emit('update:intro', ($event.target as HTMLTextAreaElement).value)" rows="4" class="service-editor-textarea" placeholder="Paragrafo introduttivo del servizio"></textarea>
			</div>
		</div>
