...
<template>
	<div :class="['desktop:hidden p-[14px] tablet:p-[16px] border-b border-[var(--color-brand-border)] bg-white', isDuplicate ? 'bg-amber-50 border-l-[3px] border-l-amber-400' : '']">
		...
		<div class="mt-[12px] flex flex-wrap gap-[10px] justify-end">
			<button @click="emit('edit', item)" class="inline-flex items-center gap-[4px] rounded-full border border-[var(--color-brand-border)] bg-white px-[12px] py-[7px] text-[0.75rem] text-[var(--color-brand-primary)] font-semibold hover:border-[var(--color-brand-primary)] cursor-pointer">
