<!--
  Checkout skeleton placeholder shown while the page initialises.
  Pure presentational — no props, no logic.
-->
<template>
  <div class="space-y-[16px] animate-pulse">
    ...
    <div class="grid grid-cols-1 desktop:grid-cols-[minmax(0,1.1fr)_360px] gap-[18px]">
      <div class="rounded-[18px] border border-[#E5EAEC] bg-white p-[18px] tablet:p-[22px] space-y-[14px]">
        <div class="h-[24px] w-[42%] rounded-[12px] bg-[#EEF3F5]"></div>
      ...
      <div class="rounded-[18px] border border-[#E5EAEC] bg-white p-[18px] space-y-[14px]">
        <div class="h-[22px] w-[58%] rounded-[12px] bg-[#EEF3F5]"></div>
