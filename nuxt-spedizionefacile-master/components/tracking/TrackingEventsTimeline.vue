		...
		<ol v-else class="event-list grid gap-0 m-0 p-0 list-none" aria-label="Eventi spedizione, dal più recente">
			...
			>
				...
				<div class="flex flex-col items-center">
					...
					>
						<!-- check -->
						<svg v-if="iconForCode(ev.code) === 'check'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
<!-- Stili estratti in assets/css/components/sf-tracking-events.css (importato da main.css). -->
