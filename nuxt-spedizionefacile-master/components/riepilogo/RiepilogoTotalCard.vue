<!--
  Card totale con badge promo per il riepilogo spedizione.
-->
<script setup>
defineProps({
...
<template>
	<div class="sf-surface-card border-[#f1d8cb] bg-[linear-gradient(135deg,#ffffff_0%,#fff8f3_72%,#fff1e8_100%)] p-[16px] tablet:p-[24px_32px] mb-[24px]">
		<div class="flex items-center justify-between gap-[12px]">
			<span class="text-[var(--color-brand-text)] text-[1rem] tablet:text-[1.125rem] font-semibold">Totale</span>
			<span class="text-[var(--color-brand-accent)] text-[1.5rem] tablet:text-[1.75rem] font-bold">{{ totalPrice }}&euro;</span>
		</div>
