    ...
    <template #body>
      <section class="sf-modal-content" role="dialog" aria-modal="true" aria-labelledby="confirm-dialog-title">
        ...
        <button
          type="button"
          :disabled="loading"
          class="btn-secondary btn-compact inline-flex items-center justify-center gap-[6px] min-h-[34px] px-[14px] disabled:opacity-60"
          @click="close"
        >
        ...
        <button
          type="button"
          :disabled="loading"
          :class="['inline-flex items-center justify-center gap-[6px] min-h-[34px] px-[14px] disabled:opacity-60 cursor-pointer', toneClasses]"
          @click="$emit('confirm')"
        >
