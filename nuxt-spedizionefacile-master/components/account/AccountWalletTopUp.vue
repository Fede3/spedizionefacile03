		...
		<div class="mt-[14px]">
			...
			<div class="relative">
				...
				<input
					...
					class="w-full rounded-[12px] border border-[#E9EBEC] bg-[#F8F9FB] py-[12px] pl-[38px] pr-[16px] text-[0.9375rem] transition-all focus:border-[#095866] focus:bg-white focus:outline-none focus:shadow-[0_0_0_3px_rgba(9,88,102,0.1)]" />
			</div>
		</div>
