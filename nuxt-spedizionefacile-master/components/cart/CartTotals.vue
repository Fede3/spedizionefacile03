  ...
  <div class="cart-totals-card">
    ...
    <div v-if="showCouponPanel" class="cart-totals-card__coupon-panel">
      ...
      <p v-if="couponMessage" class="cart-totals-card__coupon-feedback" :class="couponMessage.type === 'success' ? 'is-success' : 'is-error'">
        <svg v-if="couponMessage.type === 'success'" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
        <svg v-else width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
