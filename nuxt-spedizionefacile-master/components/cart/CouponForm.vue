...
<template>
  <div class="flex flex-col tablet:flex-row items-stretch tablet:items-center gap-3 tablet:gap-[16px] mb-5">
    ...
    <div class="w-full tablet:flex-1 tablet:max-w-[300px]">
      ...
      <div v-else class="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-[8px] h-[44px] px-[18px]">
    ...
    <button
      ...
      class="inline-flex items-center justify-center gap-1.5 bg-[#095866] text-white font-semibold text-[0.9375rem] px-[28px] min-h-[48px] w-full tablet:w-auto rounded-[50px] hover:bg-[#074a56] transition-[background-color,transform] duration-200 cursor-pointer active:scale-[0.97]">
