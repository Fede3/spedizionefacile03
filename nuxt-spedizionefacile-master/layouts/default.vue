...
<template>
	<div class="w-full min-h-screen flex flex-col overflow-x-clip">
		...
		<NuxtLink
			...
			class="fixed bottom-[24px] right-[16px] tablet:bottom-[20px] tablet:right-[20px] z-[999] w-[48px] h-[48px] tablet:w-[44px] tablet:h-[44px] rounded-full bg-[#095866] text-white flex items-center justify-center shadow-lg opacity-40 hover:opacity-100 transition-[opacity,transform] duration-300 hover:scale-110"
			title="Assistenza">
