export const accountCardIcons = {
	...
	bell: '<path d="M12,22A2,2 0 0,0 14,20H10A2,2 0 0,0 12,22M18,16V11C18,7.93 16.37,5.36 13.5,4.68V4A1.5,1.5 0 0,0 12,2.5A1.5,1.5 0 0,0 10.5,4V4.68C7.64,5.36 6,7.92 6,11V16L4,18V19H20V18L18,16Z"/>',
...
const paymentTone = {
	iconBg: '#EEF6F0',
	iconColor: '#15803D',
	iconBorder: 'rgba(21, 128, 61, 0.14)',
};

const proTone = {
	iconBg: '#F4F1FF',
	iconColor: '#6D28D9',
	iconBorder: 'rgba(109, 40, 217, 0.14)',
};
	...
	return [
		...
		},
		{
			...
			pages: [
				...
				{
					title: 'Prelievi',
					description: 'Commissioni disponibili e richieste in lavorazione.',
					url: '/prelievi',
					visible: isPro,
					iconKey: 'bank-transfer',
					iconBg: '#FFF7E8',
					iconColor: '#B45309',
					iconBorder: 'rgba(180, 83, 9, 0.14)',
				},
			],
		},
		{
			...
			pages: [
				{
					title: 'Partner Pro',
					description: 'Referral, commissioni, richiesta accesso.',
					url: '/account-pro',
					visible: true,
				...
				{
					title: 'Bonus',
					description: 'Referral, wallet e vantaggi attivi.',
					url: '/bonus',
					visible: true,
		...
		},
		{
			...
			pages: [
				...
				{
					title: 'Notifiche',
					description: 'Aggiornamenti importanti e preferenze messaggi.',
					url: '/notifiche',
					visible: true,
					iconKey: 'bell',
					...profileTone,
