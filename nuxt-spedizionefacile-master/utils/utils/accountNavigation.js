...
const secondaryTone = sharedTone;
  ...
  return [
    {
      ...
      adminOnly: true,
      pages: [
        { title: 'Dashboard', description: '', url: '/amministrazione', visible: isAdmin, iconKey: 'chart-box', ...sharedTone },
        { title: 'Ordini', description: '', url: '/amministrazione/ordini', visible: isAdmin, iconKey: 'clipboard-list', ...sharedTone },
        { title: 'Tracking BRT', description: '', url: '/amministrazione/spedizioni', visible: isAdmin, iconKey: 'truck-delivery', ...sharedTone },
        { title: 'Utenti', description: '', url: '/amministrazione/utenti', visible: isAdmin, iconKey: 'account-group', ...sharedTone },
      ],
    },
    {
      title: 'Finanze admin',
      ...
      adminOnly: true,
      pages: [
        { title: 'Saldi', description: '', url: '/amministrazione/portafogli', visible: isAdmin, iconKey: 'admin-wallet', ...sharedTone },
        { title: 'Prelievi', description: '', url: '/amministrazione/prelievi', visible: isAdmin, iconKey: 'admin-bank', ...sharedTone },
        { title: 'Referral', description: '', url: '/amministrazione/referral', visible: isAdmin, iconKey: 'share-variant', ...sharedTone },
      ],
    },
    {
      ...
      adminOnly: true,
      pages: [
        { title: 'Guide', description: '', url: '/amministrazione/guide', visible: isAdmin, iconKey: 'book-open', ...sharedTone },
        { title: 'Servizi', description: '', url: '/amministrazione/servizi', visible: isAdmin, iconKey: 'services-cog', ...sharedTone },
        { title: 'Hero homepage', description: '', url: '/amministrazione/immagine-homepage', visible: isAdmin, iconKey: 'image', ...sharedTone },
        { title: 'Prezzi', description: '', url: '/amministrazione/prezzi', visible: isAdmin, iconKey: 'tag-multiple', ...sharedTone },
        { title: 'Coupon', description: '', url: '/amministrazione/coupon', visible: isAdmin, iconKey: 'tag-multiple', ...sharedTone },
      ],
    },
    {
      title: 'Sistema',
      ...
      adminOnly: true,
      pages: [
        { title: 'Messaggi', description: '', url: '/amministrazione/messaggi', visible: isAdmin, iconKey: 'email', ...sharedTone },
        { title: 'Impostazioni', description: '', url: '/amministrazione/impostazioni', visible: isAdmin, iconKey: 'cog-outline', ...sharedTone },
        { title: 'Test BRT', description: '', url: '/amministrazione/test-brt', visible: isAdmin, iconKey: 'bug', ...sharedTone },
      ],
    },
    {
      title: 'Spedizioni',
      description: '',
      pages: [
        { title: 'Spedizioni', description: '', url: '/spedizioni', visible: true, iconKey: 'truck-fast', ...sharedTone },
        { title: 'Configurate', description: '', url: '/spedizioni-configurate', visible: true, iconKey: 'package', ...secondaryTone },
      ],
    },
    {
      title: 'Pagamenti',
      description: '',
      pages: [
        { title: 'Carte', description: '', url: '/carte', visible: true, iconKey: 'credit-card', ...sharedTone },
        { title: 'Portafoglio', description: '', url: '/portafoglio', visible: true, iconKey: 'wallet', ...secondaryTone },
        { title: 'Prelievi', description: '', url: '/prelievi', visible: isProOrAdmin, iconKey: 'bank-transfer', ...sharedTone },
      ],
    },
    {
      title: 'Profilo',
      description: '',
      pages: [
        { title: 'Profilo', description: '', url: '/profilo', visible: true, iconKey: 'account', ...sharedTone },
        { title: 'Indirizzi', description: '', url: '/indirizzi', visible: true, iconKey: 'map-marker', ...secondaryTone },
        { title: 'Supporto', description: '', url: '/assistenza', visible: true, iconKey: 'headset', ...sharedTone },
      ],
    },
  ];
};
