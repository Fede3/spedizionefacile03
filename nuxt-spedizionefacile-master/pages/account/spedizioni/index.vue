	...
	<section class="min-h-[600px] py-[40px] desktop:py-[80px]">
		<div class="my-container">
			...
			<div v-else class="bg-white rounded-[16px] p-[48px] border border-[#E9EBEC] text-center">
				...
				<NuxtLink to="/preventivo" class="inline-block px-[24px] py-[12px] bg-[#095866] hover:bg-[#074a56] text-white rounded-[50px] font-semibold text-[0.9375rem] transition-colors">Crea nuova spedizione</NuxtLink>
			</div>
		</div>
