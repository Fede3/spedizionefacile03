...
<template>
	<section class="min-h-[600px] py-[40px] desktop:py-[80px]">
		<div class="my-container">
			...
			<!-- Filters -->
			<div class="mb-[20px] rounded-[12px] border border-[#E9EBEC] bg-white px-[16px] py-[16px] shadow-sm tablet:px-[20px] tablet:py-[18px]">
			...
			<div v-if="ordersStatus === 'pending'" class="space-y-[12px]">
				<div v-for="n in 3" :key="n" class="bg-white rounded-[12px] border border-[#E9EBEC] p-[20px_24px] animate-pulse">
			...
			<!-- Empty state -->
			<div v-else class="bg-white rounded-[12px] p-[48px] border border-[#E9EBEC] shadow-sm text-center">
