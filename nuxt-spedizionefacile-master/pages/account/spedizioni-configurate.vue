				...
				<div class="bg-white border border-[#E9EBEC] rounded-[12px] p-[14px] tablet:p-[18px_20px] mb-[12px] shadow-sm">
					<div class="flex flex-col gap-[10px] tablet:flex-row tablet:items-start tablet:justify-between">
						...
						<div class="flex flex-wrap items-center gap-[8px]">
							...
							<button @click="applyFilters" type="button" class="btn-cta btn-compact inline-flex items-center justify-center gap-[6px]">
								<svg
									width="17"
									height="17"
									viewBox="0 0 24 24"
					...
					<div
						...
						<div class="flex flex-wrap items-center gap-[8px] text-[0.75rem] text-[#737373]">
							<span class="inline-flex items-center gap-[6px] rounded-full bg-[#F8F9FB] px-[10px] py-[5px] font-semibold text-[#252B42]">
