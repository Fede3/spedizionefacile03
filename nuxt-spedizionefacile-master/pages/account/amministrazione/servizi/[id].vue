					...
					<div class="bg-white rounded-[12px] p-[24px] desktop:p-[32px] shadow-sm border border-[#E9EBEC]">
						...
						<div class="space-y-[16px] max-w-[700px]">
							<div>
								...
								<input v-model="form.title" @input="generateSlug" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" placeholder="Titolo del servizio" />
							</div>
							<div>
								<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Slug (URL)</label>
								<input v-model="form.slug" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none" placeholder="titolo-del-servizio" />
							</div>
							<div>
								<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Meta description</label>
								<textarea v-model="form.meta_description" rows="2" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none resize-none" placeholder="Descrizione per i motori di ricerca"></textarea>
							</div>
							<div>
								<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Introduzione</label>
								<textarea v-model="form.intro" rows="3" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none resize-none" placeholder="Paragrafo introduttivo del servizio"></textarea>
							</div>
