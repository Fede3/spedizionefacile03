...
<template>
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container">
			...
			<div v-if="referralStats" class="mb-[20px] rounded-[12px] border border-[#E9EBEC] bg-[#F8FAFB] p-[14px] tablet:p-[18px]">
			...
			<div class="bg-white rounded-[12px] p-[24px] desktop:p-[32px] shadow-sm border border-[#E9EBEC]">
				...
				<div v-else class="space-y-[12px]">
					<div class="desktop:hidden grid grid-cols-1 tablet:grid-cols-2 gap-[12px]">
						<div v-for="usage in referralUsages" :key="usage.id" class="rounded-[12px] border border-[#E9EBEC] bg-white p-[14px] shadow-sm">
