...
<template>
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container">
			...
			<div v-if="referralLoading" class="space-y-[16px]">
				<div class="grid grid-cols-1 tablet:grid-cols-3 gap-[16px]">
					<div
						v-for="n in 3"
						:key="`referral-stat-${n}`"
						class="rounded-[12px] border border-[#E9EBEC] bg-white p-[20px] shadow-sm animate-pulse">
						<div class="h-[18px] w-[32%] rounded bg-[#E9EEF2]"></div>
						<div class="mt-[12px] h-[32px] w-[44%] rounded bg-[#E9EEF2]"></div>
					</div>
				</div>
				<div class="rounded-[12px] border border-[#E9EBEC] bg-white p-[24px] shadow-sm animate-pulse">
					...
					<div v-else class="space-y-[12px]">
						<div class="desktop:hidden grid grid-cols-1 tablet:grid-cols-2 gap-[12px]">
							<div
								...
								:key="usage.id"
								class="rounded-[12px] border border-[#E9EBEC] bg-white p-[14px] shadow-sm">
			...
			<div v-else class="rounded-[12px] border border-[#E9EBEC] bg-white p-[24px] text-center text-[#667281] shadow-sm">
