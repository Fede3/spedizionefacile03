			...
			<template v-else>
				<div class="space-y-[20px]">
					...
					<div class="bg-white rounded-[20px] p-[24px] desktop:p-[32px] shadow-sm border border-[var(--color-brand-border)]">
						...
						<div class="space-y-[16px] max-w-[700px]">
							...
							<div class="flex items-center gap-[12px]">
								...
								<span class="text-[0.875rem] text-[var(--color-brand-text)]">{{ form.is_published ? 'Pubblicata' : 'Bozza (non visibile)' }}</span>
							</div>
						</div>
					</div>
					...
					<div class="bg-white rounded-[20px] p-[24px] desktop:p-[32px] shadow-sm border border-[var(--color-brand-border)]">
						...
						<div class="max-w-[700px]">
							<div v-if="form.image_url" class="mb-[16px]">
								...
								<img :src="form.image_url" alt="Immagine guida" loading="lazy" decoding="async" class="max-w-full max-h-[200px] rounded-[20px] border border-[var(--color-brand-border)] object-cover" />
							</div>
							<label class="btn-secondary btn-compact inline-flex items-center gap-[8px]">
					...
					<div class="flex justify-end">
							<button @click="saveGuide" :disabled="saving" type="button" class="btn-cta btn-compact inline-flex items-center gap-[8px] disabled:opacity-50">
