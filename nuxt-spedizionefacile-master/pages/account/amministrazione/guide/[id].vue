			...
			<template v-else>
				<div class="space-y-[20px]">
					...
					<div class="bg-white rounded-[20px] p-[24px] desktop:p-[32px] shadow-sm border border-[#E9EBEC]">
						...
						<div class="space-y-[16px] max-w-[700px]">
							<div>
								...
								<input v-model="form.title" @input="generateSlug" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[50px] text-[0.875rem] focus:border-[#095866] focus:outline-none" placeholder="Titolo della guida" />
							</div>
							<div>
								<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Slug (URL)</label>
								<input v-model="form.slug" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[50px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none" placeholder="titolo-della-guida" />
							</div>
							<div>
							...
							<div>
								...
								<textarea v-model="form.intro" rows="3" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[50px] text-[0.875rem] focus:border-[#095866] focus:outline-none resize-none" placeholder="Paragrafo introduttivo della guida"></textarea>
							</div>
					...
					<div class="flex justify-end">
						<button @click="saveGuide" :disabled="saving" class="px-[24px] py-[12px] bg-[#095866] hover:bg-[#074a56] text-white rounded-[50px] text-[0.875rem] font-medium transition-colors cursor-pointer disabled:opacity-50 flex items-center gap-[8px]">
