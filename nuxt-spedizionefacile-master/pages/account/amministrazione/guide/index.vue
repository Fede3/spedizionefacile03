	...
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container max-w-[1400px]">
			...
			<div class="flex items-center justify-between mb-[24px]">
				...
				<NuxtLink to="/account/amministrazione/guide/nuovo" class="px-[16px] py-[10px] bg-[#095866] hover:bg-[#074a56] text-white rounded-[10px] text-[0.875rem] font-medium transition-colors inline-flex items-center gap-[6px]">
