	...
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container">
			<AccountPageHeader
				...
				:crumbs="[{ label: 'Account', to: '/account' }, { label: 'Messaggi' }]" />
			...
			<div class="mb-[16px] grid grid-cols-1 tablet:grid-cols-[minmax(0,1fr)_220px] gap-[10px]">
				<div class="relative">
					<svg
						...
						viewBox="0 0 24 24"
						class="absolute left-[14px] top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#737373]"
						fill="currentColor">
						<path
					...
					<input
						...
						class="w-full h-[44px] pl-[42px] pr-[14px] rounded-[12px] border border-[#E9EBEC] bg-white text-[0.875rem] text-[#252B42] focus:border-[#095866] focus:outline-none" />
				</div>
				<select
					v-model="messageStatusFilter"
					class="w-full h-[44px] px-[14px] rounded-[12px] border border-[#E9EBEC] bg-white text-[0.875rem] text-[#252B42] focus:border-[#095866] focus:outline-none">
				...
				<div v-else class="grid grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-1 gap-[10px]">
					<div
						...
						:class="[
							...
							msg.read_at ? 'border-[#E9EBEC] hover:border-[#D7E1E4]' : 'border-blue-200 bg-blue-50/30 hover:border-blue-300',
						]">
