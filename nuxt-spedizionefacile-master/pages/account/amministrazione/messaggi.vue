		...
		<div class="my-container">
			...
			<div class="bg-white rounded-[12px] p-[20px] tablet:p-[24px] desktop:p-[28px] shadow-sm border border-[var(--color-brand-border)]">
				...
				<div v-if="!filteredMessages?.length" class="text-center py-[40px]">
					...
					<h2 class="text-[1.125rem] font-bold text-[var(--color-brand-text)] mb-[8px]">Nessun messaggio ricevuto</h2>
					<p class="text-[var(--color-brand-text-secondary)] text-[0.875rem]">I messaggi dal form contatti appariranno qui.</p>
				</div>
			...
			<div
				...
				<div
					...
					<div class="space-y-[12px] mb-[20px]">
						<div>
							<p class="text-[0.75rem] text-[var(--color-brand-text-secondary)]">Da</p>
