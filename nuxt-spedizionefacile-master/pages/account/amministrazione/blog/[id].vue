			...
			<template v-else>
				<div class="space-y-[20px]">
					...
					<div class="bg-white rounded-[12px] p-[24px] desktop:p-[32px] shadow-sm border border-[var(--color-brand-border)]">
						...
						<div class="max-w-[700px]">
							<div v-if="form.image_url" class="mb-[16px]">
								<img :src="form.image_url" alt="Immagine articolo" loading="lazy" decoding="async" class="max-w-full max-h-[200px] rounded-[12px] border border-[var(--color-brand-border)] object-cover" >
							</div>
					...
					<div class="flex justify-end">
						<button :disabled="saving" class="btn-cta btn-compact inline-flex items-center gap-[8px] disabled:opacity-50" @click="saveArticle">
