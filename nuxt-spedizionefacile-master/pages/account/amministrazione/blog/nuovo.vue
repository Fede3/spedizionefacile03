	...
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container max-w-[1400px]">
			...
			<div class="mb-[24px] text-[0.875rem] text-[#737373]">
				...
				<span class="mx-[8px] text-[#C8CCD0]">/</span>
				<span class="font-semibold text-[#252B42]">Nuovo articolo</span>
			</div>
			...
			<h1 class="text-[1.75rem] font-bold text-[#252B42] mb-[24px]">Nuovo articolo blog</h1>
			...
			<div class="space-y-[20px]">
				...
				<div class="bg-white rounded-[20px] p-[24px] desktop:p-[32px] shadow-sm border border-[#E9EBEC]">
					<div class="flex items-center justify-between mb-[20px]">
						...
						<button class="px-[12px] py-[6px] bg-[#F0F0F0] hover:bg-[#E0E0E0] text-[#404040] rounded-[8px] text-[0.8125rem] font-medium cursor-pointer inline-flex items-center gap-[4px]" @click="addSection">
