<!--
  FILE: pages/account/amministrazione/blog/nuovo.vue
  SCOPO: Pannello admin — creazione nuovo articolo blog con sezioni dinamiche (titolo, contenuto, immagine).
  API: POST /api/admin/articles — crea articolo blog.
  ROUTE: /account/amministrazione/blog/nuovo (middleware sanctum:auth + admin).
...
const saveArticle = async () => {
	...
	try {
		...
		showSuccess("Articolo blog creato con successo.");
		setTimeout(() => { router.push('/account/amministrazione/blog'); }, 800);
	} catch (e) { showError(e, "Errore durante la creazione dell'articolo."); }
	...
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container">
			<AccountPageHeader
				...
				description="Compila titolo, slug, contenuto e immagine di copertina. La bozza resta salvabile fino alla pubblicazione."
				:crumbs="[
