		...
		<div class="my-container">
			...
			<div class="grid grid-cols-1 desktop:grid-cols-2 gap-[16px]">
				<div class="bg-white rounded-[12px] p-[20px] tablet:p-[24px] desktop:p-[28px] shadow-sm border border-[#E9EBEC]">
					...
					<div
						class="mb-[20px] rounded-[12px] border border-[#E9EBEC] bg-[#F8F9FB] px-[16px] py-[14px] text-[0.875rem] text-[#4b5563] leading-[1.6]">
						...
						<p class="mt-[8px]">
							...
							<span class="font-medium text-[#252B42]">Publishable Key</span>
							,
							<span class="font-medium text-[#252B42]">Secret Key</span>
							e
							<span class="font-medium text-[#252B42]">Webhook Secret</span>
							.
						</p>
						<p class="mt-[8px]">
							Webhook Stripe da impostare:
							<span class="font-mono text-[0.8125rem] text-[#252B42]">{{ stripeWebhookUrl }}</span>
						</p>
					</div>
					<div class="space-y-[14px] max-w-[600px]">
						<div>
							...
							<input
								...
								type="text"
								class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none"
								placeholder="pk_..." />
						</div>
						<div>
					...
					<div class="space-y-[14px] max-w-[600px]">
						<div>
							...
							<input
								...
								type="text"
								class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
						<div>
