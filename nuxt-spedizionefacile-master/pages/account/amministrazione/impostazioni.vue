	...
	<section class="min-h-[600px] py-[40px] desktop:py-[60px] desktop-xl:py-[80px]">
		<div class="my-container">
			...
			<div class="mb-[16px] grid grid-cols-1 tablet:grid-cols-3 gap-[10px]">
				<div class="bg-white rounded-[12px] p-[14px] border border-[#E9EBEC] shadow-sm">
			...
			<div class="grid grid-cols-1 desktop:grid-cols-2 gap-[16px]">
				<div class="bg-white rounded-[12px] p-[20px] tablet:p-[24px] desktop:p-[28px] shadow-sm border border-[#E9EBEC]">
					...
					<div class="mb-[20px] rounded-[12px] border border-[#E9EBEC] bg-[#F8F9FB] px-[16px] py-[14px] text-[0.875rem] text-[#4b5563] leading-[1.6]">
					...
					<div class="space-y-[14px] max-w-[600px]">
						<div>
							...
							<input v-model="settingsData.stripe_public_key" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none" placeholder="pk_..." />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Secret Key</label>
							<input v-model="settingsData.stripe_secret_key" type="password" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none" placeholder="sk_..." />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Webhook Secret</label>
							<input v-model="settingsData.stripe_webhook_secret" type="password" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] font-mono focus:border-[#095866] focus:outline-none" placeholder="whsec_..." />
						</div>
					</div>
				</div>
				...
				<div class="bg-white rounded-[12px] p-[20px] tablet:p-[24px] desktop:p-[28px] shadow-sm border border-[#E9EBEC]">
					...
					<div class="space-y-[14px] max-w-[600px]">
						<div>
							...
							<input v-model="settingsData.brt_customer_id" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Username</label>
							<input v-model="settingsData.brt_username" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Password</label>
							<input v-model="settingsData.brt_password" type="password" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
					</div>
				</div>

				<div class="bg-white rounded-[12px] p-[20px] tablet:p-[24px] desktop:p-[28px] shadow-sm border border-[#E9EBEC] desktop:col-span-2">
					<h2 class="text-[1.125rem] font-bold text-[#252B42] mb-[20px] flex items-center gap-[8px]">
					...
					<div class="space-y-[14px] max-w-[600px]">
						<div>
							...
							<input v-model="settingsData.site_name" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Email supporto</label>
							<input v-model="settingsData.support_email" type="email" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" />
						</div>
						<div>
							<label class="block text-[0.8125rem] font-medium text-[#404040] mb-[6px]">Sovrapprezzo contrassegno (&euro;)</label>
							<input v-model="settingsData.cod_surcharge" type="text" class="w-full px-[14px] py-[10px] bg-[#F8F9FB] border border-[#E9EBEC] rounded-[12px] text-[0.875rem] focus:border-[#095866] focus:outline-none" placeholder="3.50" />
						</div>
					</div>
				</div>
			</div>
