...
const fetchShipments = async () => {
	...
	try {
		...
		shipmentsData.value = { data: [], last_page: 1 };
	}
									...
									<div class="flex flex-wrap items-center gap-[8px] mb-[6px]">
										...
										<span
											:class="[
												...
												orderStatusConfig[s.status]?.bg || 'bg-gray-50',
												orderStatusConfig[s.status]?.text || 'text-gray-700',
											]">
								...
								<tr
									...
									<td class="py-[14px]">
										<span
											...
											<svg
												v-else-if="s.status === 'completed' || s.status === 'payed'"
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 24 24"
												class="w-[12px] h-[12px]"
												fill="currentColor">
											...
											<svg
												v-else-if="s.status === 'cancelled' || s.status === 'payment_failed'"
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 24 24"
												class="w-[12px] h-[12px]"
												fill="currentColor">
											...
											<svg
												v-else-if="s.status === 'in_giacenza'"
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 24 24"
												class="w-[12px] h-[12px]"
												fill="currentColor">
