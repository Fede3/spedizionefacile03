  ...
  <section class="min-h-[500px] py-[40px] desktop:py-[60px]">
    <div class="my-container">
      <div class="bg-white rounded-[20px] border border-[#E9EBEC] shadow-sm p-[32px_20px] desktop:p-[48px] max-w-[560px] mx-auto text-center">
        ...
        <NuxtLink
          to="/"
          class="inline-flex items-center gap-[8px] px-[24px] py-[12px] rounded-[10px] text-white font-semibold text-[0.9375rem] bg-[#E44203] hover:bg-[#c93a03] transition-colors duration-200"
        >
