/**
 * usePaymentFlow — Stripe initialization, card element, payment method selection,
 * and payment processing logic.
 *
 * Extracted from useCheckout to keep each composable focused.
 * Handles: Stripe SDK loading, publishable key resolution, card element lifecycle,
 * payment method toggling, confirm modal, and the full payment processing flow
 * (card/bonifico/wallet).
 */
import { createClientSubmissionId, ensureClientSubmissionId, readClientSubmissionId } from '~/utils/shipment';
