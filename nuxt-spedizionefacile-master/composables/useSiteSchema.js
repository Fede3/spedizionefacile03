...
/**
 * @typedef {Object} SiteSchemaBundle
 * @property {Record<string, unknown>} organizationSchema
 * @property {Record<string, unknown>} websiteSchema
 */
 ...
 */
export const buildSiteSchema = (overrideBaseUrl) => {
