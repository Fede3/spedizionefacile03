/**
 * useAdminPrezzi — pannello admin prezzi (consolidato 2026-04-20).
 *
 * Composable unico che raccoglie State + Form + Import + List.
 * Usato da pages/account/amministrazione/prezzi.vue.
 *
 * Sezioni interne:
 *   1. Costanti default (weight/volume bands, supplementi, europa, servizi, fees)
 *   2. Normalizzatori (list/tiers/group/europe) + buildPricingRulesPayload
 *   3. Form section: editing inline, CRUD fasce/supplementi, conversioni cents<->euro,
 *      ladder helpers, servizi/Europa helpers
 *   4. Import section: fetch/save price-bands + promo-settings, seed, payload builders
 *   5. List section: view state, filtri Europa/servizi, computed entries
 *   6. Facade: compone le sezioni e restituisce API pubblica unificata (backward compatible)
 */
...
// ────────────────────────────────────────────────────────────
// 3. Form section
// (Merged from useAdminPrezziForm.js — 2026-04-20)
...
// ────────────────────────────────────────────────────────────
// 4. Import section
// (Merged from useAdminPrezziImport.js — 2026-04-20)
...
// ────────────────────────────────────────────────────────────
// 5. List section
// (Merged from useAdminPrezziList.js — 2026-04-20)
