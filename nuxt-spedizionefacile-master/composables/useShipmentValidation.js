/**
 * COMPOSABLE: useShipmentValidation (useShipmentValidation.js)
 * SCOPO: Validazione form spedizione, errori, messaggi utente-friendly, field assist.
 *
 * DOVE SI USA: pages/la-tua-spedizione/[step].vue (step 2-3 — validazione indirizzi)
 *
 * COSA RESTITUISCE:
 *   - validateForm(): valida tutti i campi e ritorna true/false
 *   - formErrorSummary, groupedFormErrors, sectionsWithErrorsCount
 *   - showGlobalFormSummary, originSectionHint, destinationSectionHint
 *   - softenErrorMessage(): traduce errori tecnici in italiano amichevole
 *   - fieldClass(), fieldErrorText(), getFieldError(), getFieldAssist(), applyFieldAssist()
 *   - focusFormError(), focusFirstFormError(), focusContentDescriptionField()
 *   - contentError, contentFieldHint
 *   - showValidation
 *   - toAddressPayload(): formatta indirizzo per il backend
 */
