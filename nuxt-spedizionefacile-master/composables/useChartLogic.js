 ...
 * @typedef {{ date?: string | Date | null, count?: NumericLike, value?: NumericLike, orders?: NumericLike, amount?: NumericLike, revenue?: NumericLike }} RawSeriesPoint
 * @typedef {{ key: string, label: string, fullLabel: string, value: number, date: string | null }} NormalizedPoint
 * @typedef {{ status?: string, key?: string, label?: string, count?: NumericLike, value?: NumericLike }} RawStatusItem
 * @typedef {{ key: string, label: string, count: number, share: number }} ChartSegment
 */
