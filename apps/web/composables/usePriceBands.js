 ...
 * usePriceBands.js
 *
 * Listini, fallback, normalizzazione e calcolo delle fasce prezzi (peso/volume),
 * supplementi CAP e quote Europa. Espone un singleton condiviso lato client e
 * un set di getter pubblici utilizzati dal flusso preventivo.
 *
 * Le funzioni helper esportate sono pure (nessuna reattività né side-effect)
 * e vengono riusate sia dal composable sia dalla controparte admin.
 */
