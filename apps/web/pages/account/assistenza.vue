								...
								<div class="flex items-start gap-[14px]">
									<div
										...
										<svg
											...
											class="h-[19px] w-[19px]"
											fill="currentColor"
											v-html="accountCardIcons[action.iconKey]"/>
									</div>
				...
				<div
					...
					<div class="mt-[18px] flex flex-col gap-[12px] tablet:flex-row tablet:items-center tablet:justify-between">
						...
						<button
							...
							@click="handleSubmit">
							<svg v-if="!isSending" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-[18px] w-[18px]" fill="currentColor">
