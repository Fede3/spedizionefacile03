...
<template>
	<div style="background: var(--gradient-page-surface); min-height: 100vh">
		...
		<div class="py-[20px] sm:py-[24px]">
			...
			<div
class="rounded-[16px] overflow-hidden mb-[18px]"
				data-shadow="soft">
				<!-- Accent bar teal -->
				...
				<div class="p-[18px] sm:p-[22px]" style="background: var(--gradient-page-surface)">
					...
					<div
class="rounded-[16px] p-[12px]"
						data-surface="grey-inset">
						<div class="flex gap-[10px]">
							<div class="relative flex-1">
								<svg
class="absolute left-[14px] top-1/2 -translate-y-1/2 text-[#C0C5CC] pointer-events-none"
			...
			<div
v-if="trackingResult && trackingResult.found"
				...
				<div class="p-[20px] sm:p-[24px]" style="background: var(--gradient-page-surface)">
					...
					<div
class="rounded-[16px] p-[14px] sm:p-[16px] mb-[16px]"
						data-surface="grey-inset">
					...
					<div v-if="currentStepIndex >= 0" class="mb-[16px]">
						...
						<div
class="rounded-[16px] p-[16px] sm:p-[20px]"
							data-surface="grey-inset">
...
v-if="idx < statusTimeline.length - 1"
			...
			<div
v-else-if="trackingResult && !trackingResult.found"
				class="rounded-[16px] overflow-hidden text-center"
				data-shadow="soft">
				<div class="h-[4px]" data-accent="bar" />
				<div class="p-[22px] sm:p-[28px]" style="background: var(--gradient-page-surface)">
					<div
class="w-[60px] h-[60px] rounded-full flex items-center justify-center mx-auto mb-[14px]"
					...
					<!-- Suggerimenti utili -->
					<div
class="rounded-[12px] p-[14px] text-left mb-[16px] max-w-[400px] mx-auto"
						data-surface="grey-inset">
...
class="rounded-[16px] overflow-hidden mb-[18px]"
					...
					<div class="p-[18px] sm:p-[22px]" style="background: var(--gradient-page-surface)">
						<div class="grid gap-[14px]">
							...
							<div
class="rounded-[12px] p-[14px] sm:p-[16px]"
								data-surface="grey-inset">
