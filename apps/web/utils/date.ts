...
const parseItalianDateString = (value: DateInput): Date | null => {
...
const formatWithFallback = (formatter: Intl.DateTimeFormat, value: DateInput, fallback = INVALID_DATE_LABEL) => {
	const parsed = toValidDate(value)
	return parsed ? formatter.format(parsed) : fallback
}

export const formatDateIt = (value: DateInput, fallback = INVALID_DATE_LABEL) =>
	formatWithFallback(dateFormatter, value, fallback)

export const formatDateTimeIt = (value: DateInput, fallback = INVALID_DATE_LABEL) =>
	formatWithFallback(dateTimeFormatter, value, fallback)
