		...
		<div v-if="showForm" class="bg-white rounded-[16px] p-[24px] border border-[var(--color-brand-border)]">
			...
			<div class="grid grid-cols-2 desktop:grid-cols-4 gap-[12px]">
				...
				<div>
					...
					<input v-model="newPackage.quantity" type="number" min="1" max="999" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" >
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Peso (kg)</label>
					<input v-model="newPackage.weight" type="number" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required >
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Lunghezza (cm)</label>
					<input v-model="newPackage.first_size" type="number" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required >
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Larghezza (cm)</label>
					<input v-model="newPackage.second_size" type="number" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required >
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Altezza (cm)</label>
					<input v-model="newPackage.third_size" type="number" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required >
				</div>
				<div class="col-span-2">
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Contenuto</label>
					<input v-model="newPackage.content_description" type="text" placeholder="es. Elettronica" maxlength="255" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" >
				</div>
			</div>
