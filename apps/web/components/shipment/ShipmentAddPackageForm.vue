			...
			<div class="grid grid-cols-2 desktop:grid-cols-4 gap-[12px]">
				<div>
					...
					<select
						...
						class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]"
				...
				<div>
					...
					<input type="number" :value="packageField('quantity')" min="1" max="999" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" @input="updatePackageField('quantity', $event.target.value)">
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Peso (kg)</label>
					<input type="number" :value="packageField('weight')" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required @input="updatePackageField('weight', $event.target.value)">
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Lunghezza (cm)</label>
					<input type="number" :value="packageField('first_size')" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required @input="updatePackageField('first_size', $event.target.value)">
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Larghezza (cm)</label>
					<input type="number" :value="packageField('second_size')" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required @input="updatePackageField('second_size', $event.target.value)">
				</div>
				<div>
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Altezza (cm)</label>
					<input type="number" :value="packageField('third_size')" min="0.1" max="1000" step="0.1" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" required @input="updatePackageField('third_size', $event.target.value)">
				</div>
				<div class="col-span-2">
					<label class="block text-[0.75rem] text-[var(--color-brand-text-secondary)] mb-[4px]">Contenuto</label>
					<input type="text" :value="packageField('content_description')" placeholder="es. Elettronica" maxlength="255" class="w-full bg-[#F8F9FB] border border-[var(--color-brand-border)] rounded-[16px] p-[8px] text-[0.875rem]" @input="updatePackageField('content_description', $event.target.value)">
				</div>
			</div>
