...
<template>
  <div class="flex flex-col gap-[16px]">
    ...
    <button
      type="button"
      class="inline-flex items-center justify-center gap-[8px] text-[14px] font-medium text-[var(--color-brand-primary)] hover:text-[#0a7489] hover:opacity-80 cursor-pointer transition-colors bg-transparent border-0 p-0"
      @click="emit('back')"
    >
